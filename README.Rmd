...
The goal of twokenizer is to provide a wrapper around Ark-TweetNLP's part-of-speech tagger, along with an easier download function for both the tagger itself and the alternative models provided, which can also be found here: http://www.cs.cmu.edu/~ark/TweetNLP/
...
Additionally, one may choose to employ Penn Treebank tags if the model is downloaded:
```{r}
library(twokenizer)
twokenizer(tagger_location = "~/ark-tweet-nlp-0.3.2",
           text = "ikr smh he asked fir yo last name so he can add u on fb lololol",
